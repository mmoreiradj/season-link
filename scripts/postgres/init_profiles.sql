--- Create the profiles DB and its associated user ---
CREATE DATABASE profiles;

CREATE USER profiles WITH PASSWORD 'profiles';

GRANT ALL PRIVILEGES ON DATABASE profiles TO profiles;

\connect profiles

--- Fill the schema into the DB ---
...
--- Important to place it at the end so the permissions are set
GRANT ALL PRIVILEGES ON DATABASE profiles TO profiles;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO profiles;
...
DECLARE
    i INT := 1;
    uuids UUID[] := ARRAY['78be69c6-508b-40b3-b9f4-dd62703f15b5', 'ba00fcf5-6078-45af-b646-f7a0ff8c742f', '1840f235-23f0-4d96-bbdc-04d5e7dc471c', '2e33ab65-2075-4c2b-8b31-445d0fa0ae72'];
